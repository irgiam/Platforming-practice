...
public class EnemyAIMyVersion : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        //this.transform.position = Vector2.MoveTowards(this.transform.position, (Vector2)path.vectorPath[currentWayPoint], speed * Time.deltaTime);
